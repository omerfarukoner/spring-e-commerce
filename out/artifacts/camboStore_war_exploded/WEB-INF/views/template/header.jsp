...
<!-- Navigation -->
<nav class="navbar navbar-expand-lg bg-primary nav-inverse  fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="<c:url value="/"/> #page-top">Start Bootstrap</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="<c:url value="/"/>#services">Product</a>
                </li>
                <li class="nav-item">
